...
describe('backend-express-template routes', () => {
  ...
  // test 1
  it.skip('GET return all movies data', async () => {
    const res = await request(app).get('/movies');
    expect(res.body.length).toEqual(10);
  });

  // test 2 - GET movies 5 DETAIL
  it.skip('GET return movies 5', async () => {
  ...
  // test 3 - POST
  it.skip('POST should create new movie in data base', async () => {
    const newMovie = {
      id: '11',
  ...
  // test 4 - PUT
  it.skip('PUT /movies/6 should update with new director', async () => {
  ...
  // test 5 - DELETE
  it.skip('DELETE /movies/4 should be deleted', async () => {
